...
import 'shared features/auth/data/auth_controller.dart';
import 'core/controllers/global_controller.dart';
import 'core/services/api_service.dart';
import 'core/services/hive_service.dart';
import 'core/langs/app_translations.dart';
...
void main() async {
  final Logger logger = Logger(
    printer: PrettyPrinter(
      colors: true, // تمكين الألوان (للتطوير فقط)
      // printTime: true,
    ),
  );
  ...
  Get.put(ApiService(client: Get.find(), networkService: Get.find()));
